// Resolve API base URL from environment (supports dev and production)
// Prefer NEXT_PUBLIC_API_URL for client-side usage; fallback to API_URL or default localhost
const API_BASE_URL =
