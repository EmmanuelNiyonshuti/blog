...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px-40px)] flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 py-8">
      <form onSubmit={handleSubmit} className="max-w-md w-full space-y-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Sign in to manage your blog</p>
        </div>
