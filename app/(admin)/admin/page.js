  ...
  return (
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-200 mt-2">Overview</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => {
            ...
            return (
              <div key={stat.name} className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
                <div className="flex items-center">
                  <div className={`p-2 rounded-lg bg-opacity-10 ${stat.color}`}>
                    <Icon size={24} className={stat.color} />
                  </div>
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-200">{stat.name}</p>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow">
          <div className="p-6">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-200 mb-4">Recent Activity</h2>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-200 mb-4">Quick Actions</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a
              href="/admin/posts/new"
              className="flex items-center justify-center px-4 py-3 bg-blue-600 dark:bg-gray-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
            >
